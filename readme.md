...
Para que todo funcione bien el proyecto debes tener un par de cosas antes jsjs:

1. **JDK 24:** Para nuestro proyecto debes tener la jdk 24.0.1 para que pueda funcionar bien
y puesdes descargarla desde el siguiente link: https://download.oracle.com/java/24/archive/jdk-24.0.1_windows-x64_bin.zip


2. **Extas para mail:** En este caso deberas descargar dos librerias extras las cuales son las siguientes:
